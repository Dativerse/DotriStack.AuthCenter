    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-white p-4">
            <div className="w-full max-w-sm">
                <h1 className="text-2xl font-medium text-center text-gray-800">Terms and Conditions</h1>
                <p className="text-sm text-gray-600 text-center mt-2">Please review and accept to continue</p>
                <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                        <Checkbox id="agree" {...register("agree", { required: "You must agree to continue" })} />
